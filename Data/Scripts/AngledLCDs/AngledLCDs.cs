...
namespace Natomic.AngledLCDs
{
    ...
    public class AngledLCDs : MySessionComponentBase
    {
        public static AngledLCDs Instance; // the only way to access session comp from other classes and the only accepted static field.
